...
const ProjectsContent = ({ setCurrentPage, onSearch }) => {
  ...
  const techStack = {
    languages: [
      { name: "JavaScript", percentage: 53.50, color: "#f7df1e" },
      { name: "Python", percentage: 26.35, color: "#3776ab" },
      { name: "TypeScript", percentage: 5.69, color: "#3178c6" },
      { name: "Ruby", percentage: 5.69, color: "#cc342d" },
      { name: "HTML", percentage: 4.87, color: "#e34f26" },
      { name: "Java", percentage: 3.91, color: "#ed8b00" }
    ],
    frameworks: [
      "React JS", "React Native", "NodeJS", "Next JS", "Flask", "Django", "Tailwind CSS", "Postgres",
  ...
  const handleImageUpload = (e, projectId) => {
    ...
    if (file) {
      ...
      reader.onload = (ev) => {
        setUploadedImages(prev => ({ ...prev, [projectId]: ev.target.result }))
      }
                  ...
                  <div className="project-content-wrapper">
                    ...
                    <div className="project-side-image">
                      <label className="project-image-upload">
                        ...
                        />
                        {uploadedImages[project.id] ? (
                          <img src={uploadedImages[project.id]} alt="Project" />
                        ) : (
                          <span className="upload-label">Add Image</span>
                        )}
                      </label>
                    </div>
                  </div>
          ...
          <div className="projects-right">
            <div className="tech-stack-section">
              ...
              <div className="tech-description">
                <p>I love building impact-driven, full-stack projects.</p>
                <p>Currently, I'm working on specializing my technical skills in ML</p>
              </div>
